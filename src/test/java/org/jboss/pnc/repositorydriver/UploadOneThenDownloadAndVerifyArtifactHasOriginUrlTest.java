...
public class UploadOneThenDownloadAndVerifyArtifactHasOriginUrlTest extends org.jboss.pnc.indyrepositorymanager.AbstractImportTest {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(org.jboss.pnc.indyrepositorymanager.UploadOneThenDownloadAndVerifyArtifactHasOriginUrlTest.class);
    ...
    public void extractBuildArtifacts_ContainsTwoUploads() throws Exception {
        ...
        assertThat("Failed to upload: " + url, org.jboss.pnc.indyrepositorymanager.ArtifactUploadUtils.put(client, url, content), equalTo(true));
