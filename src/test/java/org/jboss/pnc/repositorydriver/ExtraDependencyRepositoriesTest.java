...
public class ExtraDependencyRepositoriesTest extends org.jboss.pnc.indyrepositorymanager.AbstractImportTest {
    ...
    @Test //TODO the extra repositories given as input param should be included in the build group
