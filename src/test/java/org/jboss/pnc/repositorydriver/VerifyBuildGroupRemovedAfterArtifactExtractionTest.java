...
public class VerifyBuildGroupRemovedAfterArtifactExtractionTest extends org.jboss.pnc.indyrepositorymanager.AbstractImportTest {

    //TODO make sure the deleteGroup operation is called
    @Test
    public void extractBuildArtifactsTriggersBuildRepoPromotionToChainGroup() throws Exception {
        ...
        BuildExecution execution = new org.jboss.pnc.indyrepositorymanager.fixture.TestBuildExecution(buildId);
